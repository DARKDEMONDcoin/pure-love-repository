...
const versus = [
  ...
  { q: "الإعلانات وإدارتها", chat: "تنسخ نص الإعلان وتدير الحملة بنفسك", sahl: "موظف متخصص لبناء الإعلانات وإدارتها — من تنفيذ مدير أفضل شركة تسويق وترجمة في مصر، بخبرة الأفضل لكل مجال وشخص بالأعلانات الممولة" },
  { q: "صناعة المحتوى البصري", chat: "تكتب نصًا وتصمّم الوسائط بنفسك", sahl: "يولّد فيديوهات وريلزات وصورًا وكل ما تحتاجه بنفسه" },
  { q: "حل مشكلة المشروع", chat: "نصائح عامة لا تخص حالتك", sahl: "أعلى خبرة في تشخيص مشكلة كل مشروع وتحويله إلى مشروع يدر أرباحًا بلا سقف" },
] as const;
...
export function EditorialHomepage() {
  ...
  return <div className="sahl-white-home" dir="rtl">
    <section className="sahl-hero" aria-labelledby="home-title"><div className="sahl-hero-ribbon" aria-hidden="true"><i /><i /><i /></div><div className="sahl-shell sahl-hero-layout"><Reveal className="sahl-hero-copy"><div className="sahl-live-metric" aria-label="١٠٨ قدرة جاهزة، ٤٠ تكاملاً، ٦ موظفين بالعربية"><span><b>١٠٨</b> قدرة جاهزة</span><i aria-hidden="true">•</i><span><b>٤٠</b> تكاملاً</span><i aria-hidden="true">•</i><span><b>٦</b> موظفين بالعربية</span></div><h1 id="home-title">اللي محتاج شهر يتعمل...<br />يتعمل <em>قبل ما تخلص قهوتك.</em></h1><p className="sahl-first-claim">أول منصة ذكاء اصطناعي عربية.</p><p className="sahl-lead">يكتبولك، يصمملك، يبيعولك، وانت بس بتشوف النتيجة بتكبر.</p><div className="sahl-actions"><Button asChild size="lg"><Link to="/auth" search={{ mode: "signup" as const }}>كوّن فريقك مجانًا <ArrowLeft /></Link></Button><Button asChild size="lg" variant="outline"><Link to="/pricing">الخطط والأسعار <ArrowLeft /></Link></Button></div><small><CheckCircle2 /> تجربة ١٤ يومًا · لا نطلب بطاقة بنكية</small></Reveal><div className="sahl-hero-product"><span className="sahl-hero-wash" aria-hidden="true" /><ProductFrame src={sonnyDesktop} mobileSrc={sonnyMobile} alt="مساحة عمل سهل: محادثة سِراج داخل المنصة" hero /></div><div className="sahl-float-note liquid-glass-sahl" role="status"><span className="sahl-float-note-icon"><Check aria-hidden="true" /></span><div><b>بانتظار اعتمادك</b><small>٣ مخرجات جاهزة للمراجعة</small></div><i className="sahl-float-note-dot" aria-hidden="true" /></div></div></section>
