      ...
      <div className="mx-auto max-w-6xl px-5">
        <Reveal>
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="section-lead">سهل يمنحك فريقًا رقميًا عربيًا يعمل داخل حساباتك: يناقشك، ينفّذ مهامك، وينظّم وقتك — وأنت تتابع كل شيء من مساحة عمل واضحة تجمع النقاش، الجدولة، والإنجاز في مكان واحد.</p>
          </div>
        </Reveal>
        <Reveal delay={100}>
